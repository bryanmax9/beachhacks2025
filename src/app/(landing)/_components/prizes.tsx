    ...
    return (
        <div className="relative">
            ...
            <div className="flex flex-wrap md:px-28  align-middle items-center justify-center md:flex-row flex-col md:gap-x-14 gap-y-5 mt-5">
                <PrizeWidget name="iphone" image={test}/>
                <PrizeWidget name="$100000" image={test}/>
                <PrizeWidget name="new car" image={test}/>
                <PrizeWidget name="a house" image={test}/>
                <PrizeWidget name="tuition paid" image={test}/>
            </div>
        </div>
    )
}